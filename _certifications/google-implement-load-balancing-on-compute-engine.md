...
excerpt: "Earning this certification validates the ability to implement load balancing solutions on Google Cloud Platform, including configuring network and HTTP load balancers, deploying virtual machines in Compute Engine, and running containerized applications on Kubernetes Engine.<br/><img src='/images/google-implement-load-balancing-on-compute-engine.png'>"
date: 2024-10-05
collection: certifications
---

![](/images/google-implement-load-balancing-on-compute-engine.png)
